...
第一种CL设计下的 stage2 车辆生成文件 CL1_s2
一共5条lane，低车流密度
...
第一种CL设计下的 stage3 车辆生成文件 CL1_s3
一共5条lane，中车流密度
- 中密度：
...
第一种CL设计下的 stage4 车辆生成文件 CL1_s4
一共5条lane，高车流密度
- 中密度：
...
# with open("sumo/route_CL1_s2.rou.xml", "w") as routes:
# with open("sumo/route_CL1_s3.rou.xml", "w") as routes:
with open("sumo/route_CL1_s4.rou.xml", "w") as routes:
    # 配置所有的车辆属性和所有的路线
    print("""<routes>
